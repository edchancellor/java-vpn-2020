...
public class ForwardServer
{
        ...
        throws Exception
    {
        ...
        while(true) {
            ...
            boolean handshake_successful = true;
            try
            {
            ...
            */
            if(handshake_successful)
            {
                ...
                serverHandshake.targetHost, serverHandshake.targetPort, serverHandshake.getSessionEncrypter(), serverHandshake.getSessionDecrypter());
